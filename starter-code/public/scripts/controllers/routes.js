...
(function(method){
  var pages = {};
  pages.page('/', app.Article.fetchAll(app.articleView.initIndexPage));
  pages.page('/admin', app.Article.fetchAll(app.adminView.initAdminPage));
  pages.page('/new', app.newArticle.initNewArticlePage());
